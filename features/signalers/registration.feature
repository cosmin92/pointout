...
Scenario: Registrazione effettuata con successo
   Quando inserisco il nome "Mario" nel campo nome del form di registrazione come segnalatore
        E inserisco il cognome "Mario" nel campo cognome del form di registrazione come segnalatore
   ...
   Allora devo vedere un messaggio che mi dica che la reggistrazione è avvenuta con successo
...
Schema dello scenario: Registrazione fallita
   ...
   Allora la registrazione deve fallire e devo essere informato sulla causa del fallimento
        E devo essere indirizzato di nuovo verso la pagina di registrazione di un segnalatore
...
| mari3 |   Rossi |mario.rossi@gmail.com | 3396523492 | passwordsicura |       passwordsicura |    via Garibaldi |           105 |           Roma, RM | 00153|    AO1234567 | Roma(RM) |    17/03/2013 |    17/03/2018 |
...
| Mario |   ross3 |mario.rossi@gmail.com | 3396523492 | passwordsicura |       passwordsicura |    via Garibaldi |           105 |           Roma, RM | 00153|    AO1234567 | Roma(RM) |    17/03/2013 |    17/03/2018 |